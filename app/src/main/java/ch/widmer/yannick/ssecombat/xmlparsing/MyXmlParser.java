...
public class MyXmlParser {
    ...
    public MyXmlParser(InputStream ip, XmlPullParser parser) {
    ...
    public class Entry {
        ...
        //Not set bools are false by default
        public boolean getBool(String bool) {
            if(hasAttribute(bool) && !attributes.get(bool).equals("true") && !attributes.get(bool).equals("false"))
                Log.w(LOG,"There is a bool not set to true or false: "+bool);
            return hasAttribute(bool) && attributes.get(bool).equals("true");
        }
